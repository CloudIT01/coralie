    ...
    <section id="blog" className="py-20 bg-gradient-to-br from-gray-50 to-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <Link key={article.id} to={article.link} className="group">
              <article className="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 h-full">
                ...
                <div className="p-6 flex flex-col h-[calc(100%-12rem)]">
                  ...
                  <p className="text-[#678187] mb-4 leading-relaxed flex-grow">
                    {article.excerpt}
                  </p>
        ...
        <div className="text-center">
          <Link to="/blog" className="inline-flex items-center space-x-2 bg-white border-2 border-[#027199] text-[#027199] px-8 py-3 rounded-lg font-semibold hover:bg-[#027199] hover:text-white transition-all duration-300 shadow-md hover:shadow-lg">
